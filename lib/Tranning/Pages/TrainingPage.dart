...
import 'package:dslab/Tranning/Contents/Quiz%20Contents.dart';
import 'package:dslab/Tranning/Contents/TextResources.dart';
    ...
    Container ResultPage = Container(
      ...
      decoration: BoxDecoration(
        image: DecorationImage(
          image: AssetImage('images/resultbg.jpg'),
          fit: BoxFit.fill,
        ),
      ),
      child: Column(
                  ...
                  Positioned(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                          fontSize: 34,
                          fontWeight: FontWeight.bold,
                          color: Colors.green.shade600,shadows: [
                            Shadow(
